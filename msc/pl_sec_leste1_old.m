...
for k=1:lx;
  ...
  eval(['load filtrados/lesteI_ctd',XX,'.dat']);
...
eval(['save filtrados/lesteI_agp_',radial,'.mat agp'])
eval(['save filtrados/lesteI_T_',radial,'.mat Ti'])
eval(['save filtrados/lesteI_S_',radial,'.mat Si'])
