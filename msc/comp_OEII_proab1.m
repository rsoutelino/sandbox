...
m_proj('mercator','long',[-41 -35.7],'lat',[-22.2 -16.7],'on');
...
%         set(xl,'Position',[pos(1) pos(2)*1.01 pos(3)]);
       %%% LEGENDA PROFUNIDADE %%%
       mt = m_text(-41+0.1,-22.2+0.2,[num2str(pp),' m'],'fontsize',11,...
...
%          eval(['save mat/uv_psi_ref_OEII_',num2str(pp),'m.mat psi U V'])
        ...
        eval(['print -depsc /home/rafaelgs/mestrado/tex/figuras/comp_OEII_proab1_',num2str(pp),'m.eps'])
        eval(['!epstopdf /home/rafaelgs/mestrado/tex/figuras/comp_OEII_proab1_',num2str(pp),'m.eps'])
