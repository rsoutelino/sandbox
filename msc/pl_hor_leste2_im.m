...
% usa como condicao de contorno o metodo das imagens
...
%%% APLICANDO CONDICOES DE CONTORNO PARA PSI  - IMAGENS ********************************
...
% espelhando os valores
[lon,lat,psig] = image_sc(lon,lat,psig,xcont,ycont);
