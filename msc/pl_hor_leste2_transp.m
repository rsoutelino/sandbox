...
eval(['save ../mat/lesteII_vgao_sec',num2str(sec),'.mat  vgao dist prof ysec xsec xbt ybt zbt'])
...
tit = ['Velocidade Geostrofica - OEII - ',num2str(latsec),'^\circS [m s^{-1}]'];
...
set(gca,'plotboxaspectratio',[1 .7 1])
   ...
   eval(['print -depsc ../figuras/vgAO_leste2_sec',num2str(sec),'.eps'])
   eval(['!epstopdf ../figuras/vgAO_leste2_sec',num2str(sec),'.eps'])
