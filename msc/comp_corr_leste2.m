...
plot([0 1200],[0 0],'k--')
axis([0 500 -0.1 1.1])
title('Funcao de Correlacao Gaussiana - OEII','fontweight','bold')
xlabel('Lag (km)')
ylabel('Correlacao')
t1 = ['Lc = ',num2str(sqrt(2)*sigma/1.852/60),' ^{\circ}'];
t2 = ['E^2 = ',num2str(1-c)];
text(350,0.7,t1,'fontsize',12,'fontweight','bold')
text(350,0.6,t2,'fontsize',12,'fontweight','bold')
grid

print -depsc ../figuras/comp_corr_leste2.eps
!epstopdf ../figuras/comp_corr_leste2.eps
