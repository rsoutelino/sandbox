...
Y2 = [A2*sin((2*pi/T)*t(1:N/2)) A2*sin((2*pi/(T*2))*t((N/2):N))];
...
for k=0:N-1
  ...
  R22(k+1)=(1/(N-k))*sum( Y2(1:N-k).*Y2(k+1:N) );
...
% Exerc�io: plote as fun�es NORMALIZADAS cf. pg. 374-376h =findobj('color',[0 0 1])