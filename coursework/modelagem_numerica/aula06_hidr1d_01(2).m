...
% COM ESQUEMA DE PRIMEIRA ORDEM NO TEMPO E SEGUNDA NO ESPACO. 
...
for m=2:mmax
   ...
   arg=omega*tempo;
% LOOPS NO ESPACO 
	uren(2:jmax-1)=uatu(2:jmax-1)-qu*(eatu(2:jmax-1)-eatu(1:jmax-2));
    eren(2:jmax-1)=eatu(2:jmax-1)-qe*(uren(3:jmax)-uren(2:jmax-1));
% CONDICOES DE CONTORNO DE CORRENTE
   uren(1)=2*uren(2)-uren(3);
   uren(jmax)=eren(jmax-1)*ragh;
