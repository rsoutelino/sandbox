...
xx = [1:51 53:63 65 67 68 70:80 82:113];  
...
% masking fields for OA errors > 30 %
To(find(er > 30)) = NaN; So(find(er > 30)) = NaN; Do(find(er > 30)) = NaN;
psigo(find(er > 30)) = NaN; uo(find(er > 30)) = NaN; vo(find(er > 30)) = NaN;
