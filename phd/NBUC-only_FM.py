...
# clearing memory
del h, VS, MeanDens, RHO
del c, col, con, cosr, d, d1, d2, dvdz, grdfile
...
del looprange, r, rho0, rhoaux, taux, saux, tmp, v, v0, v01, v02, v0max
del vaux, xx, yaux, z0max, z1, z2, zrho, zz, XAUX, YAUX, aux, lonr, latr, uaux
...
sp.savemat('NBUC-only_FM.mat', matdict)
