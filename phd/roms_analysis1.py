...
days        = range(0,360,1) # length of the series
vsc         = (-0.3, 0.3+0.03)
...
plt.title('NBUC Transport @ '+ str(abs(niN)) +'$^\circ$S')
p1.set_xticklabels(' ')
...
plt.title('SEC Transport @ '+ str(abs(njE)) +'$^\circ$W')
plt.ylabel('Transport [Sv]')
plt.xlabel('Days')
...
plt.title('BC and NBUC Transport @ '+ str(abs(niS)) +'$^\circ$S')
plt.xlabel('Days')
plt.ylabel('Transport [Sv]')
