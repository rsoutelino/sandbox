...
grdfile  = nc.Dataset('/home/rsoutelino/rsoutelino/myroms/phd_run/phd6_grd.nc')
...
grdfile  = nc.Dataset('/home/rsoutelino/rsoutelino/myroms/phd_run/phd13_grd.nc')
...
sp.savemat('BC-NBUC_FM_flat-bottom.mat', matdict)
...
matdict = {'lon':X, 'lat': Y, 'z': Z, 'temp':TEMP, 'salt':SALT, 'u':U, 'v':V, 'ubar':UBAR, 'vbar':VBAR, 'ssh':SSH}
sp.savemat('FLAT-BC-NBUC_FM_flat-bottom.mat', matdict)
...
matdict = {'lon':X, 'lat': Y, 'z': Z, 'temp':TEMP, 'salt':SALT, 'u':U, 'v':V, 'ubar':UBAR, 'vbar':VBAR, 'ssh':SSH}
sp.savemat('FLAT_FM_flat-bottom.mat', matdict)
